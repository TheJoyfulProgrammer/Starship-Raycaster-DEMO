...
A multi-layered demo powered by SDL3, Vulkan 1.3+, and FreeType. The demo provides: A raycasting demo, health vignette, GUI, large map GUI, palette-building techniques, histograms, variety of color palettes, and multiple dithering techniques.
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175215.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175302.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175311.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175327.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175335.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175344.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175352.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-175401.png)

The eighth embedded color palette is muted Teal.

![Screenshot](/assets/images/Screenshot-2026-02-08-175425.png)

The ninth embedded color palette is Vermilion.

![Screenshot](/assets/images/Screenshot-2026-02-08-175432.png)

The tenth embedded color palette is grayscale.

![Screenshot](/assets/images/Screenshot-2026-02-08-175437.png)

The fragment shader effect was just the first layer rendered by the demo. The second layer is the raycasting demo.

![Screenshot](/assets/images/Screenshot-2026-02-08-175531.png)

Dropping the pixelation size back down to 1x1, the is plenty of room for higher-resolution graphics.

![Screenshot](/assets/images/Screenshot-2026-02-08-175538.png)

What good is a raycasting video game without a GUI system? Well, this demo provides a fourth layer just for that feature.

![Screenshot](/assets/images/Screenshot-2026-02-08-175556.png)

The GUI system even provides a large-map view with legend.

![Screenshot](/assets/images/Screenshot-2026-02-08-175609.png)

The large map can be zoomed in and out with the mouse scroll wheel.

![Screenshot](/assets/images/Screenshot-2026-02-08-175634.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-175723.png)

There are three CRT modes in the demo.

![Screenshot](/assets/images/Screenshot-2026-02-08-175733.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-175740.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-175747.png)

These CRT modes affects all layers.

![Screenshot](/assets/images/Screenshot-2026-02-08-175757.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-175811.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-175909.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-175935.png)

There are doors, doors with windows, and windows.

![Screenshot](/assets/images/Screenshot-2026-02-08-180144.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-180144.png)
![Screenshot](/assets/images/Screenshot-2026-02-08-180306.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-180318.png)

The game demo also allows for sprites, which can be used for assets and NPCs.

![Screenshot](/assets/images/Screenshot-2026-02-08-180332.png)

Decreasing the alpha channel for the game layer, can lead to fascinating effects.

![Screenshot](/assets/images/Screenshot-2026-02-08-180517.png)
...
![Screenshot](/assets/images/Screenshot-2026-02-08-180605.png)

As the health moves towards 1%, the players triangle fades to red and the vignette gets larger.

![Screenshot](/assets/images/Screenshot-2026-02-08-180635.png)

When the players health reaches 0%, the triangle becomes dark red.

![Screenshot](/assets/images/Screenshot-2026-02-08-180651.png)
